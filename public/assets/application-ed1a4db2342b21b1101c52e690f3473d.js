...
(function() {
  jQuery(function() {
    return $("input[id*='event_category_ids']").click(function() {
      if ($(this).prop('checked')) {
        $(this).parent().removeClass('btn-default');
        return $(this).parent().addClass('btn-info');
      } else {
        $(this).parent().removeClass('btn-info');
        return $(this).parent().addClass('btn-default');
      }
    });
  });

  jQuery(function() {
    return $("input[id*='event_domain_ids']").click(function() {
      if ($(this).prop('checked')) {
        $(this).parent().removeClass('btn-default');
        return $(this).parent().addClass('btn-info');
      } else {
  ...
  jQuery(function() {
    return $("input[id*='event_eligible_ids']").click(function() {
      if ($(this).prop('checked')) {
        $(this).parent().removeClass('btn-default');
        return $(this).parent().addClass('btn-info');
      } else {
  ...
  jQuery(function() {
    return $("input[id*='user_eligible_ids']").click(function() {
      if ($(this).prop('checked')) {
        $(this).parent().removeClass('btn-default');
        return $(this).parent().addClass('btn-info');
      } else {
  ...
  jQuery(function() {
    return $("input[id*='user_domain_ids']").click(function() {
      if ($(this).prop('checked')) {
        $(this).parent().removeClass('btn-default');
        return $(this).parent().addClass('btn-info');
      } else {
  ...
  jQuery(function() {
    return $("input[id*='user_category_ids']").click(function() {
      if ($(this).prop('checked')) {
        $(this).parent().removeClass('btn-default');
        return $(this).parent().addClass('btn-info');
      } else {
